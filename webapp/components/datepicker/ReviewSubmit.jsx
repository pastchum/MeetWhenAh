...
export default function ReviewSubmit({ data, prevComponent, nextComponent}) {
    ...
    return (
        <div className="relative w-full max-w-md mx-auto minecraft-font" data-testid="summary">
            {/* Animated Background */}
            <div className="mb-16 relative">
                {/* Floating Sprites Animation */}
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-4 left-4 w-2 h-2 bg-[#e5e5e5] animate-pulse"></div>
                    <div className="absolute top-8 right-6 w-1 h-1 bg-[#c44545] animate-bounce" style={{animationDelay: '0.5s'}}></div>
                    <div className="absolute bottom-12 left-8 w-1 h-1 bg-white animate-ping" style={{animationDelay: '1s'}}></div>
                    <div className="absolute top-16 right-12 w-2 h-2 bg-[#8c2e2e] animate-pulse" style={{animationDelay: '1.5s'}}></div>
                </div>

                {/* Mobile Game UI Card */}
                <div className="relative bg-gradient-to-b from-[#2a2a2a] via-[#1a1a1a] to-[#0a0a0a] border-4 border-[#8c2e2e] shadow-2xl minecraft-font rounded-lg overflow-hidden" 
                     style={{
                         background: 'linear-gradient(to bottom, #2a2a2a, #1a1a1a, #0a0a0a)',
                         boxShadow: '0 0 20px rgba(196, 69, 69, 0.3), inset 0 2px 4px rgba(140, 46, 46, 0.2)'
                     }}>
                    ...
                    <div className="px-6 py-4 text-center border-b-2 border-[#8c2e2e] relative minecraft-font">
                        {/* Side Sprites */}
                        <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-xl animate-bounce">🎉</span>
                        <span className="absolute right-4 top-1/2 transform -translate-y-1/2 text-xl animate-bounce" style={{animationDelay: '0.3s'}}>🎉</span>
                        ...
                        <div className="mb-4 p-3 bg-gradient-to-r from-[#2a2a2a]/50 to-[#1a1a1a]/50 border border-[#8c2e2e]/50 minecraft-font">
                            <div className="flex items-start space-x-2">
                                ...
                                <div className="flex-1">
                                    <div className="text-[#c44545] minecraft-font text-xs font-bold mb-1">Description</div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div className="p-3 bg-gradient-to-r from-[#8c2e2e]/30 to-[#c44545]/30 border border-[#8c2e2e] minecraft-font">
                                <div className="text-center">
                                    <div className="flex justify-center items-center space-x-1 mb-1">
                                        ...
                                        <span className="text-[#c44545] minecraft-font text-xs font-bold">EARLIEST FROM</span>
                                    </div>
                            ...
                            <div className="p-3 bg-gradient-to-r from-[#c44545]/30 to-[#8c2e2e]/30 border border-[#8c2e2e] minecraft-font">
                                <div className="text-center">
                                    <div className="flex justify-center items-center space-x-1 mb-1">
                                        <span className="text-lg">🎯</span>
                                        <span className="text-[#c44545] minecraft-font text-xs font-bold">LATEST BY</span>
                                    </div>
                                    <div className="text-white minecraft-font text-sm font-bold">
                                        {formatDate(data.end)}
                                    </div>
            ...
            <div className="absolute bottom-0 right-0">
                ...
                >
                    ...
                    <span className="transform translate-y-0.5 minecraft-font">Submit</span>

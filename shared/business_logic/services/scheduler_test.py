...
class SchedulerTest(unittest.TestCase):
    ...
    def test_is_within_sleep_hours(self):
        scheduler = Scheduler()
        event_block = {"start_time": "2025-01-01T10:00:00+08:00", "end_time": "2025-01-01T11:00:00+08:00", "participants": ["1","2"], "duration": 60, "participant_count": 2}
    ...
    def test_score_event_block(self):
        scheduler = Scheduler()
        event_block = {"start_time": "2025-01-01T10:00:00+08:00", "end_time": "2025-01-01T11:00:00+08:00", "participants": ["1","2"], "duration": 60, "participant_count": 2}
        score = scheduler._score_event_block(event_block)
    ...
    def test_get_best_event_block(self):
        ...
        event_blocks = [
            ...
            {"start_time": "2025-01-01T11:00:00+08:00", "end_time": "2025-01-01T12:00:00+08:00", "participants": ["1","2","3"], "duration": 60, "participant_count": 3}
        ]
        best_event_blocks = scheduler._get_best_event_block(event_blocks)
        self.assertEqual(best_event_blocks, [{"start_time": "2025-01-01T11:00:00+08:00", "end_time": "2025-01-01T12:00:00+08:00", "participants": ["1","2","3"], "duration": 60, "participant_count": 3}])

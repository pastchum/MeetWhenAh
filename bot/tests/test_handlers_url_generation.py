...
class TestEventHandlersURLGeneration:
    ...
    def test_create_command_generates_correct_url(self, mock_bot, mock_put_ctx, mock_get_mini_app_url):
        ...
        mock_get_mini_app_url.return_value = "https://t.me/test_dev_bot/meetwhenah?startapp=datepicker=token%3Dtest_token_123"
    ...
    def test_handle_event_creation_generates_correct_confirm_url(self, mock_bot, mock_get_event, mock_get_mini_app_url):
        ...
        mock_get_mini_app_url.return_value = "https://t.me/test_dev_bot/meetwhenah?startapp=confirm=event_id%3Dtest_event_456"
    ...
    def test_event_get_event_button_generates_correct_urls(self, mock_get_mini_app_url):
        ...
        mock_get_mini_app_url.side_effect = [
            "https://t.me/test_dev_bot/meetwhenah?startapp=dragselector=event_id%3Dtest_event",
            "https://t.me/test_dev_bot/meetwhenah?startapp=confirm=event_id%3Dtest_event"
        ]
...
class TestShareHandlersURLGeneration:
    ...
    def test_share_command_generates_correct_url(self, mock_bot, mock_put_ctx, mock_get_mini_app_url):
        ...
        mock_get_mini_app_url.return_value = "https://t.me/test_dev_bot/meetwhenah?startapp=share=token%3Dshare_token_789"
...
class TestParameterValidation:
    ...
    def test_url_encoding_of_special_characters(self):
        """Test that special characters in parameters are properly URL encoded"""
        # Test with special characters
        url = get_mini_app_url("test", param="value with spaces & symbols!")
        expected = "https://t.me/test_dev_bot/meetwhenah?startapp=test=param%3Dvalue+with+spaces+%26+symbols%21"
        assert url == expected
    
    def test_empty_parameters(self):
        """Test handling of empty parameters"""
        url = get_mini_app_url("test", empty_param="")
        expected = "https://t.me/test_dev_bot/meetwhenah?startapp=test=empty_param%3D"
        assert url == expected
    
    def test_none_parameters(self):
        """Test handling of None parameters"""
        url = get_mini_app_url("test", none_param=None)
        expected = "https://t.me/test_dev_bot/meetwhenah?startapp=test=none_param%3DNone"
        assert url == expected
    
    def test_unicode_parameters(self):
        """Test handling of Unicode parameters"""
        url = get_mini_app_url("test", unicode_param="测试中文")
        expected = "https://t.me/test_dev_bot/meetwhenah?startapp=test=unicode_param%3D%E6%B5%8B%E8%AF%95%E4%B8%AD%E6%96%87"
        assert url == expected
...
class TestEnvironmentSwitching:
    ...
    def test_environment_switching(self):
        ...
        assert "startapp=test=param%3Dvalue" in dev_url
        ...
        assert "startapp=test=param%3Dvalue" in staging_url

...
"""
    ...
    def test_score_event_block(self):
        scheduler = Scheduler()
        event_block = {"start_time": "2025-01-01 10:00:00", "end_time": "2025-01-01 11:00:00", "participants": ["1", "2"]}
        self.assertEqual(scheduler._score_event_block(event_block), 2)

    def test_get_best_event_block(self):
        scheduler = Scheduler()
        event_blocks = [
            {"start_time": "2025-01-01 10:00:00", "end_time": "2025-01-01 11:00:00", "participants": ["1", "2"]},
            {"start_time": "2025-01-01 11:00:00", "end_time": "2025-01-01 12:00:00", "participants": ["1", "2"]},
        ]
        self.assertEqual(scheduler._get_best_event_block(event_blocks), event_blocks[0])

...
class SchedulerTest(unittest.TestCase):
    def test_create_availability_map(self):
        ...
        self.assertEqual(availability_map, {datetime.strptime("2025-01-01 10:00:00", "%Y-%m-%d %H:%M:%S"): ["1"], datetime.strptime("2025-01-01 11:00:00", "%Y-%m-%d %H:%M:%S"): ["2"]})
        ...
        self.assertEqual(availability_map_test_2, 
                         {
                             datetime.strptime("2025-01-01 10:00:00", "%Y-%m-%d %H:%M:%S"): ["1"],
                             datetime.strptime("2025-01-01 10:30:00", "%Y-%m-%d %H:%M:%S"): ["1", "3"],
                             datetime.strptime("2025-01-01 11:00:00", "%Y-%m-%d %H:%M:%S"): ["2"],
                             datetime.strptime("2025-01-01 11:30:00", "%Y-%m-%d %H:%M:%S"): ["2"],
                             datetime.strptime("2025-01-01 12:00:00", "%Y-%m-%d %H:%M:%S"): ["1"],
                             datetime.strptime("2025-01-01 12:30:00", "%Y-%m-%d %H:%M:%S"): ["2", "3"],
                             datetime.strptime("2025-01-01 13:00:00", "%Y-%m-%d %H:%M:%S"): ["1"],
                         })
    ...
    def test_create_event_blocks(self):
        ...
        availability_blocks = [
            {"start_time": "2025-01-01 10:00:00", "end_time": "2025-01-01 10:30:00", "event_id": "1", "user_uuid": "1"},
            {"start_time": "2025-01-01 10:30:00", "end_time": "2025-01-01 11:00:00", "event_id": "1", "user_uuid": "1"},
            {"start_time": "2025-01-01 10:00:00", "end_time": "2025-01-01 10:30:00", "event_id": "1", "user_uuid": "2"},
    ...
    def test_is_within_sleep_hours(self):
        scheduler = Scheduler()
        event_block = {"start_time": "2025-01-01 10:00:00", "end_time": "2025-01-01 11:00:00", "participants": ["1", "2"]}
    ...
    def test_score_event_block(self):
        ...
        event_block_2 = {"start_time": "2025-01-01 10:00:00", "end_time": "2025-01-01 11:00:00", "participants": ["1", "2", "3"]}
        self.assertGreater(scheduler._score_event_block(event_block_2), scheduler._score_event_block(event_block))
        event_block_3 = {"start_time": "2025-01-01 10:00:00", "end_time": "2025-01-01 11:30:00", "participants": ["1", "2", "3"]}
    ...
    def test_get_best_event_block(self):
        scheduler = Scheduler()
        event_blocks = [
            {"start_time": "2025-01-01 10:00:00", "end_time": "2025-01-01 11:00:00", "participants": ["1", "2"], "duration": 60, "participant_count": 2},
            {"start_time": "2025-01-01 11:00:00", "end_time": "2025-01-01 12:00:00", "participants": ["1", "2"], "duration": 60, "participant_count": 2},
        ]
        self.assertEqual(scheduler._get_best_event_block(event_blocks), event_blocks)
        event_blocks_2 = [
            {"start_time": "2025-01-01 10:00:00", "end_time": "2025-01-01 11:00:00", "participants": ["1", "2"], "duration": 60, "participant_count": 2},
            {"start_time": "2025-01-01 11:00:00", "end_time": "2025-01-01 12:00:00", "participants": ["1", "2"], "duration": 60, "participant_count": 2},
            {"start_time": "2025-01-01 12:30:00", "end_time": "2025-01-01 14:00:00", "participants": ["1", "2"], "duration": 90, "participant_count": 2},
        ]
    ...
    def test_process_availability_blocks(self):
        scheduler = Scheduler()
        availability_blocks = [
            {"start_time": "2025-01-01 10:00:00", "end_time": "2025-01-01 11:00:00", "event_id": "1", "user_uuid": "1"},
            {"start_time": "2025-01-01 11:00:00", "end_time": "2025-01-01 12:00:00", "event_id": "1", "user_uuid": "2"},
        ]
        ...
        self.assertEqual(scheduler._process_availability_blocks(avail_blocks_test_2), 
                         [{"start_time": "2025-01-01 10:30:00", "end_time": "2025-01-01 11:30:00", "participants": ["1","2"], "duration": 60, "participant_count": 2}])
